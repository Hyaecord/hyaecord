...
export const IPC = {
  ...
  discordStartQrLogin: "hyaecord:discord-start-qr-login",
  discordCancelQrLogin: "hyaecord:discord-cancel-qr-login",
  discordQrLoginEvent: "hyaecord:discord-qr-login-event",
